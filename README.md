# Zigbee2MQTT Instance 01 — Home Assistant Add-on

[![CI](https://github.com/alex-savin/hassio-app-zigbee2mqtt-01/actions/workflows/ci.yml/badge.svg)](https://github.com/alex-savin/hassio-app-zigbee2mqtt-01/actions/workflows/ci.yml)

A modified copy of the [official Zigbee2MQTT Home Assistant add-on](https://github.com/zigbee2mqtt/hassio-zigbee2mqtt) with a unique slug (`zigbee2mqtt-01`) to allow running multiple Zigbee2MQTT instances side-by-side, each with its own Zigbee coordinator.
...
2. Add this repository URL:
   ```
   https://github.com/alex-savin/hassio-app-zigbee2mqtt-01
   ```
3. Install **Zigbee2MQTT Instance 01** from the store.
4. Configure:
   - Select your Zigbee coordinator (serial port or network adapter).
   - Set a **unique MQTT base topic**: `zigbee2mqtt-01` (Settings → MQTT in the Z2M frontend).
